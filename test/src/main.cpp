...
{
    auto builder(ctor<tuple<double, int, string>>::defaultedWith(double(41.3), int(2), string("who?"))
...
{
    auto builder(ctor<tuple<double>>::defaultedWith(double(2.1234))
                     .overridenBy("value"));
...
void test_ctor_with_two_variables()
{
    ...
    auto b(ctor<tuple<double, string>, map_type>::defaultedWith(double(2.1234), string("hello"))
...
void test_2_args_with_2_vars()
{
    ...
    auto a(ctor<product_type, map_type>::defaultedWith(int(0), double(0))
